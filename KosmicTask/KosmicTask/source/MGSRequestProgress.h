...
@property (nonatomic) eMGSRequestProgress value;
...
@property (nonatomic) unsigned long long requestSizeTransferred;
@property (weak, readonly) NSString *requestSizeTransferredString;
@property (nonatomic) unsigned long long requestSizeTotal;
