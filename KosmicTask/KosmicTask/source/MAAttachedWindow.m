...
- (void)setBorderWidth:(float)value {
    if ((NSUInteger)borderWidth != (NSUInteger)value) {
...
- (void)setViewMargin:(float)value {
    if ((NSUInteger)viewMargin != (NSUInteger)value) {
        viewMargin = (float)MAX(value, 0.0);
...
- (void)setArrowHeight:(float)value {
    if ((NSUInteger)arrowHeight != (NSUInteger)value) {
        arrowHeight = value;
...
- (void)setHasArrow:(float)value {
    if ((NSUInteger)hasArrow != (NSUInteger)value) {
        hasArrow = value;
...
- (void)setCornerRadius:(float)value {
    ...
    cornerRadius = (float)MAX(cornerRadius, 0.0);
...
- (void)setDrawsRoundCornerBesideArrow:(float)value {
    if ((NSUInteger)drawsRoundCornerBesideArrow != (NSUInteger)value) {
