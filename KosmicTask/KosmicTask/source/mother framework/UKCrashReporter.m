...
-(void)	awakeFromNib
{
	...
	if( gCrashLogString )
		expln = [[[explanationField stringValue] mutableCopy] autorelease];
	else
		expln = [[NSLocalizedStringFromTable(@"FEEDBACK_EXPLANATION_TEXT",@"UKCrashReporter",@"") mutableCopy] autorelease];
