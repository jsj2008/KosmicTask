...
/*!
	@method nd_URLWithFileSystemPathHFSStyle:
	@abstract Alloc and intialize a <tt>NSURL</tt>.
	...
	@result A <tt>NSURL</tt> containing a file url.
 */
+ (NSURL *)nd_URLWithFileSystemPathHFSStyle:(NSString *)hfsString;

/*!
 @method nd_URLWithFileSystemPathPOSIXStyle:
 @abstract Alloc and intialize a <tt>NSURL</tt>.
 @discussion Returns a file url for the file refered to by a POSIX style path.
 @param hfsString A <tt>NSString</tt> containing a POSIX style path.
 @result A <tt>NSURL</tt> containing a file url.
 */
...
/*!
 @method nd_fileSystemPathPOSIXStyle
 @abstract Returns a POSIX style path.
 @discussion Returns a <tt>NSString</tt> containg a POSIX style path.
 @result A new <tt>NSString</tt> containing a POSIX style path for the same file or directory as the receiver.
 */
