...
/*!
	...
	@discussion <tt>NDScriptData</tt> is the base class for <tt>NDScriptHandler</tt> and <tt>NDScriptContext</tt>. Instances of <tt>NDScriptData</tt> can represent script data.
*/
...
/*!
 @method dispose:
 @abstract GC dispose method.
 @discussion Safely disposes of all resources.
 @result None.
 */
...
@protected
	...
	OSAError				resultOSAError;	// MGS 15-10-08
}
...
// MGS 15-1008
// added to give access to OSAXXX function return values.
// normally error info can be retrieved from OSAScriptError if errOSAScriptError is returned.
// in some cases however errAEEventNotHandled may be returned, for which OSAScriptError returns no info.
...
/*!
	...
	@discussion NDScriptContext is what you normal think of when you think of an compiled AppleScript, a NDScriptContext can contain multiple script handlers and script properites.
*/
