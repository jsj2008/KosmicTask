...
/*!
 @method findNextComponentInstance
 @abstract Allocates and initializes a <tt>NDComponentInstance</tt>
 @discussion Returns a <tt>NDComponentInstance</tt> with a connection to the next OSA Apple component.
...
/*!
 @method setSendProc:
 @abstract Set OSA send proc.
 @discussion Sets the AE send proc to be used by the instance.
 @result None.
 */
- (void)setSendProc:(OSASendUPP) sendProc;

/*!
 @method restoreSendProc:
 @abstract Restore OSA send proc.
 @discussion Restores the AE send proc to be used by the instance.
 @result None.
 */
