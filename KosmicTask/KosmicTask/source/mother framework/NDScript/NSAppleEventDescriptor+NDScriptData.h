...
/*!
 ...
 @abstract .
 @discussion <tt>descriptorWithDate:</tt> returns a decriptor of type <tt>'ldt '</tt>.
 @param aDate The date to create a <tt>NSAppleEventDescriptor</tt> from.
 @result A <tt>NSAppleEventDescriptor</tt> for a long date time.
 */
...
/*!
	...
	@result A <tt>NSAppleEventDescriptor</tt> for a list descriptor.
 */
+ (NSAppleEventDescriptor *)listDescriptorWithObjects:(id)firstObject, ...;
...
/*!
	...
	@result A <tt>NSAppleEventDescriptor</tt> for a record descriptor.
*/
+ (NSAppleEventDescriptor *)descriptorWithObjectAndKeys:(id)object, ...;
 ...
 */
+ (NSAppleEventDescriptor *)userRecordDescriptorWithObjectAndKeys:(id)object, ...;
...
/*!
	...
	@result A <tt>NSAppleEventDescriptor</tt> for a subroutine with labled arguments.
 */
+ (NSAppleEventDescriptor *)descriptorWithSubroutineName:(NSString *)routineName labelsAndArguments:(AEKeyword)keyWord, ...;
