...
@interface AsyncSocket : NSObject
{
	...
	__strong CFSocketContext theContext;	// JM 23-02-08 GC compatability
...
//- (void) dealloc; // JM 23-02-08  GC compatibility
//- (void) closeAndDispose; // JM 23-02-08  GC compatibility
- (BOOL)disconnectCalled; // JM 23-02-08  GC compatibility
...
//- (long) userData; // JM 23-02-08  GC compatibility
//- (void) setUserData:(long)userData; // JM 23-02-08  GC compatibility
